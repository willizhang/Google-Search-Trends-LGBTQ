...
p_lgbtq <- 
  ...
  scale_x_date(
    limits = c( as.Date( "2009-01-01" ), as.Date( "2025-03-01" ) ),
...
long_data <- long_data %>%
  mutate(
    Icon_Label = factor( recode( Search_Term, !!!icon_labels ),
                         levels = c( "Canada (🌈)", "Sweden (🌈)", "UK (🌈)", "US (🌈)", "UK (🍉)" ) ) )
...
icon_labels <- c(
  ...
  "LGBTQ: (United States)" = "US (\U1F308)",
  "LGBTQ: (Canada)" = "Canada (\U1F308)",
  "Ice cream: (United Kingdom)" = "UK (\U1F366)" )
...
icon_labels <- c(
  ...
  "LGBTQ: (United States)" = "US (\U1F308)",
  "LGBTQ: (Canada)" = "Canada (\U1F308)",
  "Mango: (United States)" = "US (\U1F96D)" )

long_data <- long_data %>%
  mutate(
    Icon_Label = factor( recode( Search_Term, !!!icon_labels ),
                         levels = c( "Canada (🌈)", "Sweden (🌈)", "UK (🌈)", "US (🌈)", "US (🥭)" ) ) )
